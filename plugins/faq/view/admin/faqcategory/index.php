        ...
        <div class="col-sm-3">
            <div class="card">
                <div class="card-body text-center">
                    <a href="<?php echo SITE_ADMIN_PATH.'/index.php?pageType='.$this->_request['pageType'].'&dtls='.$this->_request['dtls'].'&dtaction=add&moduleId='.$this->_request['moduleId'];?>" class="btn btn-info">Add FAQ Category</a>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody class="swap">
                                            ...
                                            foreach($data['faqs'] as $faq) {
                                                ...
                                                ?>
                                                <tr id="<?php echo 'recordsArray_'.$faq['faq_cat_id'];?>">
                                                    <td width="40">
                                                        <input type="checkbox" name="selectMulti[]" value="<?php echo $faq['faq_cat_id'];?>" class="case" />
                                                    </td>
                                                    
                                                    <td width="60" scope="row"><?php echo $slNo;?></td>

                                                    <td>
                                                        <a href="index.php?pageType=<?php echo $this->_request['pageType'];?>&dtls=<?php echo $this->_request['dtls'];?>&dtaction=add&editid=<?php echo $faq['faq_cat_id'];?>&moduleId=<?php echo $this->_request['moduleId'];?>">
                                                            <?php echo $faq['faq_cat_title'];?>
                                                        </a>
                                                    </td>

                                                    
                                                    <td>
                                                        <?php echo $faq['faq_tag'];?>
                                                    </td>
